...
const Header = () => {
  const user = useAuth()
  const name = user.user.about.name
        ...
        <div className="container">
          <div className="st-main-header-in">
            <div className="st-main-header-left">
              <Link className="st-site-branding" to='/' id="hero"><img src="/images/logo.png" alt={name} /></Link>
            </div>
            <div className="st-main-header-right">
              <div className="st-nav">
                ...
                <div className="sp-phone">
                  ...
                  <div className="sp-phone-no">{user.user.about.phoneNumber}</div>
                </div>
              </div>
            </div>
          </div>
